...
// Toggle GO off and on
public class ToggleActiveGestureListener : MonoBehaviour, KinectGestures.GestureListenerInterface
{
    ...
    private static ToggleActiveGestureListener instance = null;
    
    /// <summary>
    /// Gets the singleton CubeGestureListener instance.
    /// </summary>
    /// <value>The CubeGestureListener instance.</value>
    public static ToggleActiveGestureListener Instance
    {
        get
        {
            return instance;
    ...
    public void UserDetected(long userId, int userIndex)
    {
        ...
        if (gestureInfo != null)
        {
            gestureInfo.text = "Swipe up, to change the face of Combine Soldier.";
        }
    }
